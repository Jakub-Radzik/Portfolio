...
function LeftOverview() {
    ...
    return (
        <Left>
            ...
            <Description>
                Jestem absolwentem Wrocławskiego Technikum Informatycznego, w którym zdobyłem podstawową wiedzę techniczną z zakresu budowy komputerów, systemów operacyjnych, sieci, a także tworzenia aplikacji internetowych z wykorzystaniem języków JavaScript, PHP, CSS i baz danych MySQL. Aktualnie studiuję Informatykę Stosowaną na Politechnice Wrocławskiej, gdzie zapoznaję się z technologią JAVA. Poza tym systematyzuję wiedzę na temat algorytmów, struktur danych i ciągle się rozwijam.
            </Description>
        </Left>
    );
}
